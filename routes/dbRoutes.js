...
exports.init = function(app) {
  ...
  app.get('/leaderboardAll', doGetAllPlayers); // CRUD Retrieve
  ...
  app.delete('/leaderboard', doDelete);
...
doGetAllPlayers = function(req, res){
  //Get the leaderboard itself
...
doUpdate = function(req, res){
   ...
   */
  mongoModel.update(  "leaderboard", filter, update,
		                  function(status) {
...
doDelete = function(req, res){
   ...
   *    model once the update has been successful.
   */
  mongoModel.delete("leaderboard", filter,
                      function(status) {
                        res.render('message',{title: 'Mongo Demo', obj: status});
                      });
}
